...
My brain loves problem-solving and I really just want to build cool things. I have always been a tech nerd, so I transitioned into software development. I recently completed the **Microsoft Software & Systems Academy (MSSA)** for Cloud Application Development, which was excellent for improving with C#, .NET, and Azure. 
